...
import type { Agent, AgentVisibility, AgentHandoffMode, RuntimeDevice, MemberWithUser } from "@multica/core/types";
import {
  Popover,
  PopoverTrigger,
  PopoverContent,
...
export function SettingsTab({
  ...
  const [handoffMode, setHandoffMode] = useState<AgentHandoffMode>(agent.handoff_mode);
  ...
  const dirty =
    ...
    handoffMode !== agent.handoff_mode ||
  ...
  return (
    <div className="max-w-lg space-y-6">
      ...
      <div>
        <Label className="text-xs text-muted-foreground">Handoff Mode</Label>
        <div className="mt-1.5 flex gap-2">
          <button
            type="button"
            onClick={() => setHandoffMode("automatic")}
            className={`flex flex-1 items-center gap-2 rounded-lg border px-3 py-2.5 text-sm transition-colors ${
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs text-muted-foreground">Moves to next agent</div>
            </div>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs text-muted-foreground">Requires human approval</div>
            </div>
          </button>
        </div>
      </div>
