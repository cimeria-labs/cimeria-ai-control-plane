...
func (h *Handler) CreateWorkspace(w http.ResponseWriter, r *http.Request) {
	...
	// Seed SDR agents and default score rules for the new workspace.
	seedSDRAgents(r.Context(), qtx, ws.ID, parseUUID(userID))
	seedDefaultScoreRules(r.Context(), qtx, ws.ID)
